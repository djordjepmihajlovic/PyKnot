...
def plot_vassiliev():   
    ...
    true_vals_v3 = [0, -1, 0, -5, -3, 1, 1, 0, -14, -6, 11]
    knots_v3 = [r'$0_{1}$', r'$3_{1}$', r'$4_{1}$', r'$5_{1}$', r'$5_{2}$', r'$6_{1}$', r'$6_{2}$', r'$6_{3}$', r'$7_{1}$', r'$7_{2}$', r'$7_{3}$']
    avgs_v3 = [0.0002337558283305493, -1.06775154096688, -0.021786476525896464, -5.75605466684332, -3.353080405326023, 1.7640745159354427, 1.3740907435768093, 0.023793775923153206, -16.516180240850172, -6.908003459709753, 12.785595712520207]
    ...
    r'measured ($I(K)_{(1,3)(2,4)}$)': avgs_v3,  
    'true': true_vals_v3
    }, index=knots_v3)
